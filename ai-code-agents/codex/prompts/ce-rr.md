...
2. **Analyze and decompose the research question:**
   ...
   - Think through the underlying patterns, connections, and architectural implications the user might be seeking
   - Identify specific components, patterns, or concepts to investigate
   - Create a concise research plan and track subtasks as needed
   - Consider which directories, files, or architectural patterns are relevant

3. **Spawn parallel sub-agent tasks for comprehensive research:**
   - Use at most 3 subagents per research query, and only when the subagent work can run independently.
   ...
   Run independent subagent searches in parallel when doing so reduces context load or elapsed time.
   ...
   **For codebase research:**
   ...
   - Run agents in parallel only if they are searching for different things.
...
6. **Generate research document:**
   ...
   - Structure the document in the following format and store in `memory-bank/research/`:
     ...
     **Phase:** Research
     ...
     Summarize all _existing knowledge_ before any new work.
...
- Use parallel subagents only when they will improve efficiency or keep noisy exploration out of the main thread
