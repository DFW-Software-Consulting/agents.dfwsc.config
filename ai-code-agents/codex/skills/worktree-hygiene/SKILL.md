...
description: Use when working with git worktrees to prevent branch contamination, especially when creating worktrees, preparing to commit, or managing multiple worktrees. Enforces fresh branches, pre-commit verification, and one worktree per issue.
---
