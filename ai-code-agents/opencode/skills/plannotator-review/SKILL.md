...
description: Use when opening Plannotator's browser-based code review UI for the current worktree or a pull request URL, then acting on returned feedback.
---
