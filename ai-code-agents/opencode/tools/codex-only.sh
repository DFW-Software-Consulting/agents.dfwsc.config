...
DEFAULT_LOCATOR_MODEL="${OPENCODE_DEFAULT_LOCATOR_MODEL:-opencode-go/minimax-m2.7}"
DEFAULT_ANALYZER_MODEL="${OPENCODE_DEFAULT_ANALYZER_MODEL:-opencode-go/kimi-k2.6}"
DEFAULT_CONTEXT_MODEL="${OPENCODE_DEFAULT_CONTEXT_MODEL:-opencode-go/qwen3.7-max}"
DEFAULT_SNIFFER_MODEL="${OPENCODE_DEFAULT_SNIFFER_MODEL:-opencode-go/minimax-m2.7}"
DEFAULT_FRONTEND_MODEL="${OPENCODE_DEFAULT_FRONTEND_MODEL:-opencode-go/kimi-k2.6}"
...
DEFAULT_CLOUD_MODEL="${OPENCODE_DEFAULT_CLOUD_MODEL:-opencode-go/qwen3.7-max}"
DEFAULT_DB_MODEL="${OPENCODE_DEFAULT_DB_MODEL:-opencode-go/qwen3.7-max}"
DEFAULT_DEPLOY_MODEL="${OPENCODE_DEFAULT_DEPLOY_MODEL:-opencode-go/qwen3.7-max}"
DEFAULT_DEVOPS_MODEL="${OPENCODE_DEFAULT_DEVOPS_MODEL:-opencode-go/qwen3.7-max}"
...
CODEX_MODEL="${OPENCODE_CODEX_MODEL:-openai/gpt-5.5-codex}"
CODEX_SMALL_MODEL="${OPENCODE_CODEX_SMALL_MODEL:-openai/gpt-5.5-codex-mini}"
